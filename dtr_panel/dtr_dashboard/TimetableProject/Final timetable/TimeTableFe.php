...
?>
        ...
        <head>
            <meta charset="utf-8">
            <title>Time Table: First Year</title>
                ...
                <div class="col-md-6 col-md-push-3">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            // echo $date1;
                            // $sql2 = mysqli_query($conn, "INSERT INTO fe_timetable (Date, FromTime, ToTime) VALUES ('$date1', '$from1', '$to1')");
                            ?>
                            <div class="col-md-4">
                    ...
                    <form id="form1" method="post" class="form-group" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>">
                        ...
                        <input type="hidden" name="Year" id="year" value="FE" /> <!-- For subjects dropdown -->
