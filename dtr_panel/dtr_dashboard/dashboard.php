      ...
      <div class="container-fluid">
        ...
        <div class="row">
          ...
          <div class="col-12 col-sm-6 col-md-3">
            ...
            <?php 
                  $conn = new class_model();
                  $att = $conn->count_numberofclass();
             ?>

              <div class="info-box-content">
               <span class="info-box-text">Number of Classroom</span>
          ...
          <div class="col-12 col-sm-6 col-md-3">
            ...
            <?php 
                  $conn = new class_model();
                  $att = $conn->count_numberofreg_id();
             ?>
              <div class="info-box-content">
              <span class="info-box-text">Number of Students Registered</span>
                <?php foreach ($att as $row): ?>
                   <span class="info-box-number">
                   <?= $row['reg_id']; ?>
                </span>
